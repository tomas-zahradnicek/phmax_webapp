...
export const SS_HERO_EXAMPLE_SELECT_LEGEND =
  "Příklady jsou anonymní a slouží jako výchozí šablony podle typické struktury střední školy (jednoobor, maturita, víceoborová třída). Údaje doplňte a upravte podle evidence školy; výsledky ověřte vůči metodice MŠMT a oficiálním výstupům.";
