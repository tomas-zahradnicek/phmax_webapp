                  ...
                  >
                    ...
                    <div className="ss-units-mini">
                      <div className="ss-units-mini__labels">
                        ...
                        <span>{sec.colAvgStudents}</span>
                        <span>{sec.colClassCount}</span>
                        <span>{sec.colStudyForm}</span>
                        <span>{sec.colPhmaxMode}</span>
                      </div>
                      <div className="ss-units-mini__inputs">
                        <input
                          type="text"
                          className="input"
                          value={row.label}
                    ...
                    <div className="ss-units-mini">
                      <div className="ss-units-mini__labels">
                        ...
                        <span>{sec.colAdditionalObors}</span>
                        <span>{sec.colOborStudentCounts}</span>
                        <span>{sec.colClassType}</span>
                        <span>{sec.colNote}</span>
                      </div>
                      <div className="ss-units-mini__inputs">
                        <input
                          type="text"
