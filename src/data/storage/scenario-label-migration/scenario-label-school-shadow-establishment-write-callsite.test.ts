...
const ALLOWED_FILES = new Set([
  ...
  "src/data/storage/scenario-label-migration/scenario-label-n3-cutover-activate.test.ts",
  "src/data/storage/scenario-label-migration/scenario-label-n3-cutover-source-contract.test.ts",
