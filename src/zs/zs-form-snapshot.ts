...
export function applyZsFormSnapshot(
  ...
  if (s.tab) setters.setTab(s.tab as ZsTabKey);
  if (s.mode) setters.setMode(s.mode as CalculatorMode);
  if (s.basicType) setters.setBasicType(s.basicType as BasicType);
  setters.setBasic1Classes((s.basic1Classes as number) ?? 0);
  setters.setBasic1Pupils((s.basic1Pupils as number) ?? 0);
  setters.setBasic2Classes((s.basic2Classes as number) ?? 0);
  setters.setBasic2Pupils((s.basic2Pupils as number) ?? 0);
  setters.setIncl1Classes((s.incl1Classes as number) ?? 0);
  setters.setIncl1Pupils((s.incl1Pupils as number) ?? 0);
  setters.setIncl2Classes((s.incl2Classes as number) ?? 0);
  setters.setIncl2Pupils((s.incl2Pupils as number) ?? 0);
  setters.setPsychRows((s.psychRows as PsychRow[]) ?? []);
  setters.setHealthRows((s.healthRows as HealthRow[]) ?? []);
  setters.setExportLabel(typeof s.exportLabel === "string" ? s.exportLabel : "");
  if (s.minorityType) setters.setMinorityType(s.minorityType as keyof typeof B17_B21);
  setters.setMinority1Classes((s.minority1Classes as number) ?? 0);
  setters.setMinority1Pupils((s.minority1Pupils as number) ?? 0);
  setters.setMinority2Classes((s.minority2Classes as number) ?? 0);
  setters.setMinority2Pupils((s.minority2Pupils as number) ?? 0);
  setters.setGymRows((s.gymRows as GymRow[]) ?? []);
  setters.setMixedRows((s.mixedRows as MixedRow[]) ?? []);
  setters.setSpecial1Classes((s.special1Classes as number) ?? 0);
  setters.setSpecial1Pupils((s.special1Pupils as number) ?? 0);
  setters.setSpecial2Classes((s.special2Classes as number) ?? 0);
  setters.setSpecial2Pupils((s.special2Pupils as number) ?? 0);
  setters.setSpecialIIClasses((s.specialIIClasses as number) ?? 0);
  setters.setSpecialIIPupils((s.specialIIPupils as number) ?? 0);
  setters.setPrepClasses((s.prepClasses as number) ?? 0);
  setters.setPrepChildren((s.prepChildren as number) ?? 0);
  setters.setPrepSpecialClasses((s.prepSpecialClasses as number) ?? 0);
  setters.setPrepSpecialChildren((s.prepSpecialChildren as number) ?? 0);
  setters.setP38First((s.p38First as number) ?? 0);
  setters.setP38Second((s.p38Second as number) ?? 0);
  setters.setP41First((s.p41First as number) ?? 0);
  setters.setP41Second((s.p41Second as number) ?? 0);
  setters.setPhaRows((s.phaRows as PhaRow[]) ?? []);
  setters.setPhpYear1((s.phpYear1 as number) ?? 0);
  setters.setPhpYear2((s.phpYear2 as number) ?? 0);
  setters.setPhpYear3((s.phpYear3 as number) ?? 0);
  if (s.phpWizardStep) setters.setPhpWizardStep(s.phpWizardStep as ZsPhpWizardStep);
  if (s.phpMethodMode) setters.setPhpMethodMode(s.phpMethodMode as ZsPhpMethodMode);
  setters.setPhpExcludedAbroad((s.phpExcludedAbroad as number) ?? 0);
  setters.setPhpExcludedForeignSchoolCz((s.phpExcludedForeignSchoolCz as number) ?? 0);
  setters.setPhpExcludedIndividual((s.phpExcludedIndividual as number) ?? 0);
  setters.setPhpExcludedSchool(Boolean(s.phpExcludedSchool));
  setters.setSelectedExample((s.selectedExample as ZsHeroExampleKey) ?? "");
  setters.setWizardChoice((s.wizardChoice as ZsWizardChoice) ?? "");
  if (typeof s.zsWizardStep === "number") {
    setters.setZsWizardStep(clampZsBasicWizardStep(s.zsWizardStep));
  }
  setters.setDataMode((s.dataMode as ZsDataMode) ?? "own");
  setters.setNv75Role(s.nv75Role === "reditel" ? "reditel" : "ucitel");
  setters.setNv75School("plavecka_skola");
  setters.setNv75TeacherMin(typeof s.nv75TeacherMin === "number" ? s.nv75TeacherMin : 22);
  setters.setNv75TeacherMax(typeof s.nv75TeacherMax === "number" ? s.nv75TeacherMax : 30);
  setters.setMixedMethodFirstZsPupils((s.mixedMethodFirstZsPupils as number) ?? 0);
  setters.setMixedMethodFirstZsClasses((s.mixedMethodFirstZsClasses as number) ?? 0);
  setters.setMixedMethodFirstSpecialPupils((s.mixedMethodFirstSpecialPupils as number) ?? 0);
  setters.setMixedMethodFirstSpecialClasses((s.mixedMethodFirstSpecialClasses as number) ?? 0);
  setters.setMixedMethodSecondZsPupils((s.mixedMethodSecondZsPupils as number) ?? 0);
  setters.setMixedMethodSecondZsClasses((s.mixedMethodSecondZsClasses as number) ?? 0);
  setters.setMixedMethodSecondSpecialPupils((s.mixedMethodSecondSpecialPupils as number) ?? 0);
  setters.setMixedMethodSecondSpecialClasses((s.mixedMethodSecondSpecialClasses as number) ?? 0);
  onNotice(notice);
}
