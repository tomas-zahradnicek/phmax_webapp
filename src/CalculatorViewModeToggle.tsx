...
export function CalculatorViewModeToggle({
  ...
  return (
    <div className={["calculator-view-mode-toggle", className].filter(Boolean).join(" ")}>
      <div className="checks" role="group" aria-label={`Režim zobrazení ${moduleLabel}`} aria-describedby={hintId}>
        <label>
