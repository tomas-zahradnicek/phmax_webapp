...
export const MODE_CONFIG: Record<CalculatorMode, ModeConfig> = {
  phmax_full_zs: {
    ...
    visibleSections: ["basic_first", "basic_second", "par38", "par41"],
  ...
  phmax_first_stage_only: {
    ...
    visibleSections: ["school_variant_first_stage_only", "basic_first", "sec16_first", "par38", "par41"],
  ...
  phmax_full_zs_sec16: {
    ...
    visibleSections: ["basic_first", "basic_second", "sec16_first", "sec16_second", "par38", "par41"],
    requiredFields: [
  ...
  phmax_dominant_field: {
    ...
    visibleSections: ["dominant_c_first", "dominant_c_second", "dominant_b_first", "dominant_b_second", "par38", "par41"],
    requiredFields: [
  ...
  phmax_psychiatric: {
    ...
    visibleSections: ["psych_groups", "par38", "par41"],
    requiredFields: [],
    methodSteps: ["A", "B", "C", "D"],
    supportsMethodView: true,
    supportsSimpleView: true,
  ...
  phmax_health_facility: {
    ...
    visibleSections: ["health_groups", "par38", "par41"],
    requiredFields: [],
    methodSteps: ["A", "B", "C", "D"],
    supportsMethodView: true,
    supportsSimpleView: true,
  ...
  phmax_minority_language: {
    ...
    visibleSections: ["minority_variant", "minority_first", "minority_second", "par38", "par41"],
  ...
  phmax_multiyear_gym: {
    ...
    visibleSections: ["gym_groups", "par38", "par41"],
    requiredFields: [],
    methodSteps: ["A", "B", "C", "D"],
    supportsMethodView: true,
    supportsSimpleView: true,
