...
/** Legenda pod rozbalovačem „Ukázkový příklad“ v hero (stejná role jako u ZŠ). Držíme v tomto souboru kvůli stabilnímu buildu při částečných commitech. */
const SS_HERO_EXAMPLE_LEGEND =
